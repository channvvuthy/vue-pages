...
module.exports = {
    ...
    theme: {
        ...
        borderColor: (theme) => ({
            ...theme('colors'), DEFAULT: theme('colors.gray.200', 'currentColor'), 'primary': '#79BDFC',
        }),
        ...
        borderWidth: {
            DEFAULT: '1px', 0: '0px', 2: '2px', 3: '3px', 4: '4px', 8: '8px',
        },
        boxShadow: {
        ...
        inset: (theme, {negative}) => ({
            auto: 'auto', ...theme('spacing'), ...negative(theme('spacing')),
            '1/2': '50%',
            '1/3': '33.333333%',
            '2/3': '66.666667%',
            '1/4': '25%',
        ...
        maxHeight: (theme) => ({
            ...theme('spacing'), full: '100%', screen: '100vh',
        }),
        ...
        minWidth: {
            0: '0px', full: '100%', min: 'min-content', max: 'max-content', 96: '24rem'
        },
        objectPosition: {
            bottom: 'bottom',
            center: 'center',
